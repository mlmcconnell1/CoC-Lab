"""CLI command for validating ACS population rollup vs CoC measures."""
...
def _run_acs_population_validation(
    boundary: Annotated[
        str,
        typer.Option(
            "--boundary",
    ...
    """Validate population rollup against existing CoC measures.
    ...
    typer.echo("Running ACS population validation...")
...
def validate_acs_population(
    ...
    """Validate population rollup against existing CoC measures."""
    _run_acs_population_validation(
        boundary=boundary,
        acs=acs,
        tracts=tracts,
        weighting=weighting,
