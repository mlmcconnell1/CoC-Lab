...
def _impl() -> ModuleType:
    return import_module("hhplab.rents.metro")
...
def aggregate_zori_to_metro(
    ...
    *,
    ...
    """Delegate to ``hhplab.rents.metro.aggregate_zori_to_metro``."""
...
def collapse_zori_to_yearly(
    ...
    """Delegate to ``hhplab.rents.metro.collapse_zori_to_yearly``."""
...
def aggregate_yearly_zori_to_metro(
    ...
    *,
    ...
    """Delegate to ``hhplab.rents.metro.aggregate_yearly_zori_to_metro``."""
