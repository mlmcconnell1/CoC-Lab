...
aggregating using :func:`hhplab.acs.aggregate.aggregate_to_geo`.
...
from hhplab.acs.aggregate import aggregate_to_geo
...
def build_metro_tract_crosswalk(
    ...
    *,
    ...
    county_membership_df : pd.DataFrame, optional
        ...
        built-in membership from ``hhplab.metro.definitions``.
...
def aggregate_acs_to_metro(
    ...
    *,
    ...
    logger.info(
        f"Metro ACS aggregation: {result_df['metro_id'].nunique()} metros"
    )
