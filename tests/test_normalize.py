...
class TestPathHelpers:
    ...
    def test_curated_boundary_path_default(self):
        """curated_boundary_path should return coc__BYYYY naming."""
        path = curated_boundary_path("2025")
        assert path == Path("data/curated/coc_boundaries/coc__B2025.parquet")

    def test_curated_boundary_path_custom_base(self):
        """curated_boundary_path should respect custom base_dir with coc__BYYYY naming."""
        path = curated_boundary_path("2025", base_dir="/custom/data")
        assert path == Path("/custom/data/curated/coc_boundaries/coc__B2025.parquet")
